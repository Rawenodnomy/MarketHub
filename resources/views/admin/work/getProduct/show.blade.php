                ...
                <div class="card card-primary">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <br>
                                <div class="form-group">
                                    <form action="{{route('work_getProduct.update', $product->id)}}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        <div class="card-footer">
                                            <button type="submit" name='status' value='3' class="btn btn-primary">Принять товар</button>
                                        </div>
                                    </form>
                                </div>
