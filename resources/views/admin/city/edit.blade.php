...
<form action="{{route('city.update', $city->id)}}" method="post" enctype="multipart/form-data" id='form_required'>
@method('PUT')
@csrf
                ...
                <div class="card card-primary">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input class="form-control required" id='name' name='name' value='{{$city->name}}'>
