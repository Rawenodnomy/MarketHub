...
<form action="{{route('subcategories.store')}}" method="post" enctype="multipart/form-data" id='form_required'>
@method('POST')
@csrf
                ...
                <div class="card card-primary">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input class="form-control required" id='name' name='name' placeholder='Название подкатегории'>
                                <br>
